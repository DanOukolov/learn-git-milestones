...
1b | Link to `commit #1 from Github.com` | [Point to Commit #1](URL 'https://github.com/DanOukolov/learn-git-milestones/commit/d1c141bb1b56fb7e45b654cdacd35e0934d61131')
1c | Link to markdown tables docs | [Link to Markdown Table Docs](URL 'https://www.pluralsight.com/guides/working-tables-github-markdown')
1d | What does `log` do? |
